  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 15 }}>
        {messages.map((m) => (
          <div key={m.id} style={{ textAlign: m.sender_id === me.id ? "right" : "left", marginBottom: 10 }}>
            <span style={{ background: "#fff", padding: 10, borderRadius: 10 }}>
              {m.message}
            </span>
          </div>
        ))}
