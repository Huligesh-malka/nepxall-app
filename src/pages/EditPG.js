...
const EditPG = () => {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          setForm(prev => ({
            ...
            tv: data.tv === true || data.tv === 'true',
            parking_available: data.parking_available === true || data.parking_available === 'true',
            bike_parking: data.bike_parking === true || data.bike_parking === 'true',
            laundry_available: data.laundry_available === true || data.laundry_available === 'true',
            washing_machine: data.washing_machine === true || data.washing_machine === 'true',
            refrigerator: data.refrigerator === true || data.refrigerator === 'true',
            microwave: data.microwave === true || data.microwave === 'true',
            geyser: data.geyser === true || data.geyser === 'true',
            power_backup: data.power_backup === true || data.power_backup === 'true',
            lift_elevator: data.lift_elevator === true || data.lift_elevator === 'true',
            cctv: data.cctv === true || data.cctv === 'true',
            security_guard: data.security_guard === true || data.security_guard === 'true',
            gym: data.gym === true || data.gym === 'true',
            housekeeping: data.housekeeping === true || data.housekeeping === 'true',
            water_purifier: data.water_purifier === true || data.water_purifier === 'true',
            fire_safety: data.fire_safety === true || data.fire_safety === 'true',
            study_room: data.study_room === true || data.study_room === 'true',
            ...
            dining_table_available: data.dining_table_available === true || data.dining_table_available === 'true',
            attached_bathroom: data.attached_bathroom === true || data.attached_bathroom === 'true',
            balcony_available: data.balcony_available === true || data.balcony_available === 'true',
            wall_mounted_clothes_hook: data.wall_mounted_clothes_hook === true || data.wall_mounted_clothes_hook === 'true',
            bed_with_mattress: data.bed_with_mattress === true || data.bed_with_mattress === 'true',
            fan_light: data.fan_light === true || data.fan_light === 'true',
            kitchen_room: data.kitchen_room === true || data.kitchen_room === 'true',
            
            co_living_fully_furnished: data.co_living_fully_furnished === true || data.co_living_fully_furnished === 'true',
            co_living_food_included: data.co_living_food_included === true || data.co_living_food_included === 'true',
            co_living_wifi_included: data.co_living_wifi_included === true || data.co_living_wifi_included === 'true',
            co_living_housekeeping: data.co_living_housekeeping === true || data.co_living_housekeeping === 'true',
            co_living_power_backup: data.co_living_power_backup === true || data.co_living_power_backup === 'true',
            co_living_maintenance: data.co_living_maintenance === true || data.co_living_maintenance === 'true',
            
            visitor_allowed: data.visitor_allowed === true || data.visitor_allowed === 'true',
            visitor_time_restricted: data.visitor_time_restricted === true || data.visitor_time_restricted === 'true',
            couple_allowed: data.couple_allowed === true || data.couple_allowed === 'true',
            family_allowed: data.family_allowed === true || data.family_allowed === 'true',
            smoking_allowed: data.smoking_allowed === true || data.smoking_allowed === 'true',
            drinking_allowed: data.drinking_allowed === true || data.drinking_allowed === 'true',
            pets_allowed: data.pets_allowed === true || data.pets_allowed === 'true',
            late_night_entry_allowed: data.late_night_entry_allowed === true || data.late_night_entry_allowed === 'true',
            outside_food_allowed: data.outside_food_allowed === true || data.outside_food_allowed === 'true',
            parties_allowed: data.parties_allowed === true || data.parties_allowed === 'true',
            loud_music_restricted: data.loud_music_restricted === true || data.loud_music_restricted === 'true',
            lock_in_period: data.lock_in_period === true || data.lock_in_period === 'true',
            agreement_mandatory: data.agreement_mandatory === true || data.agreement_mandatory === 'true',
            id_proof_mandatory: data.id_proof_mandatory === true || data.id_proof_mandatory === 'true',
            office_going_only: data.office_going_only === true || data.office_going_only === 'true',
            students_only: data.students_only === true || data.students_only === 'true',
            boys_only: data.boys_only === true || data.boys_only === 'true',
          ...
          setRoomRates(prev => ({
            ...
            double_sharing: data.double_sharing || "",
            triple_sharing: data.triple_sharing || "",
          ...
          setBhkConfig(prev => ({
            ...prev,
            bedrooms_1bhk: data.bedrooms_1bhk || "",
            bathrooms_1bhk: data.bathrooms_1bhk || "",
            bedrooms_2bhk: data.bedrooms_2bhk || "",
            bathrooms_2bhk: data.bathrooms_2bhk || "",
            bedrooms_3bhk: data.bedrooms_3bhk || "",
            bathrooms_3bhk: data.bathrooms_3bhk || "",
            bedrooms_4bhk: data.bedrooms_4bhk || "",
            bathrooms_4bhk: data.bathrooms_4bhk || "",
          }));
  ...
  const handlePhotoUpload = (e) => {
    ...
    if (photos.length + files.length + existingPhotos.length - photosToDelete.length > 10) {
  ...
  const removeExistingPhoto = (index, photoUrl) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      photosToDelete.forEach(photoUrl => {
        formData.append("photos_to_delete[]", photoUrl);
      });
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <div style={styles.section}>
          ...
          <div style={styles.checkboxGrid}>
            ...
            {[
              ...
              { key: "bed_with_mattress", label: "🛏️ Bed with Mattress" },
          ...
          <div style={styles.grid}>
            ...
            <div style={styles.inputGroup}>
              ...
              <input 
                type="number" 
                name="total_rooms" 
                placeholder={isToLet ? "e.g., 1" : "e.g., 10"} 
            ...
            <div style={styles.inputGroup}>
              ...
              <input 
                ...
                placeholder={isToLet ? "e.g., 1" : "e.g., 5"} 
        ...
        <div style={styles.section}>
          ...
          <div style={styles.grid}>
            ...
            <div style={styles.inputGroup}>
              ...
              <input type="tel" name="contact_phone" placeholder="9876543210" value={form.contact_phone} onChange={handleChange} style={styles.input} required pattern="[0-9]{10}" />
            </div>
          </div>
        </div>
        ...
        <div style={styles.section}>
          ...
          <p style={styles.note}>Add new photos or remove existing ones. Maximum 10 photos allowed.</p>
          
          {/* Existing Photos */}
          {existingPhotos.length > 0 && (
            <div style={styles.existingPhotos}>
                  ...
                  <div key={index} style={styles.photoItem}>
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        e.target.src = "https://via.placeholder.com/100x75?text=Photo";
                      }}
                    />
                    <button 
                      type="button" 
                      onClick={() => removeExistingPhoto(index, photoUrl)} 
          ...
          <p style={styles.photoCount}>
            Total Photos: {existingPhotos.length - photosToDelete.length + photos.length}/10
          </p>
        </div>
